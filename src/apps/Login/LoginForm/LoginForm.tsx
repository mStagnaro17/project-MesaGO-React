        ...
        <div className="bg-transparent rounded-2xl p-10 sm:p-12 w-full max-w-md relative">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center gap-5 w-full">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className={`w-full py-3 mt-4 text-white font-bold text-lg rounded-lg transition-all duration-200 ${isLoading
            ...
            {testResults.length > 0 && (
                <div className="mt-6 bg-gray-100 rounded-lg p-4">
                    ...
                    {testResults.map((res, i) => (
                        <div
                            key={i}
                            className={`p-2 rounded mb-2 text-center ${res.success ? "bg-green-200" : "bg-red-200"
                                }`}
                        >
